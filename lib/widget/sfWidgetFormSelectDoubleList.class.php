...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('unassociate', '<img src="/images/frontend/'.$unassociate_image.'" alt="unassociate" />');
    $this->addOption('associate', '<img src="/images/frontend/'.$associate_image.'" alt="associate" />');
...
EOF
  ...
  {
    return array('/js/frontend/double_list.js');
  }
